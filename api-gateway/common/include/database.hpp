...
template<typename... Args>
pqxx::result Database::query(pqxx::transaction_base& tx, const std::string& sql, Args&&... args) {
...
template<typename... Args>
void Database::execute(pqxx::transaction_base& tx, const std::string& sql, Args&&... args) {
